...
namespace IdentityMvc.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        private IGoogleAuthenticatorService _GoogleAuthenticatorService;

        public ManageController(IGoogleAuthenticatorService authService)
        {
            _GoogleAuthenticatorService = authService;
        }

        public ManageController(ApplicationUserManager userManager, ApplicationSignInManager signInManager, IGoogleAuthenticatorService authService)
        {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var model = new IndexViewModel
            {
                ...
                IsGoogleAuthenticatorEnabled = (await UserManager.FindByIdAsync(userId)).IsGoogleAuthenticatorEnabled
            };
            return View(model);
        }
        ...
        public ActionResult EnableGoogleAuthenticator()
        {
            ...
            var model = new GoogleAuthenticatorViewModel { QRCodeData = qrCodeData };
